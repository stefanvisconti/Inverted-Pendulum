...
const int PwmL  = 9;   //  arduino  pin 10 to l298  pin ENA
//****************************************************************************************************************************************************
...
// load and configure the DMP
 ...
 //  use calibration program to get your own values
    mpu.setXGyroOffset(-1006);//(220);
    mpu.setYGyroOffset(157);//(76);
    mpu.setZGyroOffset(-58);//(-85);
    mpu.setXAccelOffset(874);//(1788); // 1688 factory default for my test chip
    mpu.setYAccelOffset(5320);
    mpu.setZAccelOffset(3118);
 //****************************************************************************************************************************************
